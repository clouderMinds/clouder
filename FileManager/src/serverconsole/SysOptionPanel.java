...
public class SysOptionPanel extends JPanel{
	 ...
	 * 初始化该面板的方法
	 */
	public void showSysOptionPanel(){
		/*-------服务器常规设在的面板-------*/
		JPanel servet_normal=noemalSet();
	 ...
	 * @param normal_on 
	 */
	private void nomal_on_init(JPanel normal_on){
		...
		//启动和停止服务器的按钮
		JButton button_ser=new JButton("启动服务器");
