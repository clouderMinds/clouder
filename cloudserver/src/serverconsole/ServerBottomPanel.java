...
public class ServerBottomPanel extends javax.swing.JPanel{
	...
	private java.text.SimpleDateFormat dataFormat = new java.text.SimpleDateFormat(
			"yyyy/MM/dd HH:mm:ss");
	private javax.swing.JLabel server_label;//显示启动的时间
	private javax.swing.JLabel startTime;//显示启动的时间值
	/**
	 * 初始化底部的界面
	 */
	public void showServerBottomPanel(){
		...
		server_label=new javax.swing.JLabel("服务器尚未启动");
		center_panel.add(server_label);
		startTime=new javax.swing.JLabel("");
		center_panel.add(startTime);
